  ...
  if (screen === "setup") {
    return (
      <div style={s.root}>
        ...
        <div className="dna-col" style={{ flex: "0 0 580px", width: 580, paddingTop: 24, display: "flex", flexDirection: "column", gap: 0, alignSelf: "flex-start", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, overflow: "hidden" }}>
